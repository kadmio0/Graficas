...
int main() {
    ...
    LuzPuntual luz(1.0,1.0,1.0, -400.0, 700.0, 200);
    LuzPuntual luz_ambiente(1.0,1.0,1.0, 0.0, 0.0, 200.0);
...
//(-125.0, -180.0, -400.0)
    ...
    escena.push_back(&tz3);
    escena.push_back(&tz4);
    escena.push_back(&tz5);
    escena.push_back(&tz6);
    escena.push_back(&tz7);
    escena.push_back(&tz8);
    escena.push_back(&tz9);
